...
public class CheckOutPage {
    ...
    private final By proceedToCheckoutSelector = By.cssSelector(
            "li[class='method-checkout-cart-methods-onepage-bottom'] button[title='Proceed to Checkout'] span span");
    ...
    private final By orderNumberMessage = By.cssSelector(
